...
class TestIamTenantUserBasicOps:
    ...
    # === 3436 ===
    @allure.title("IAM-租户-修改用户状态-禁用并启用")
    ...
    def test_iam_tenant_reset_password(self, iam_tenant_page, iam_shared_tenant_user):
        ...
        with allure_step_log(f"步骤1: 重置用户 {disp} 的密码"):
            ...
            iam_tenant_page.wait_for_page_ready()
    ...
    # === 3438 ===
    @allure.title("IAM-租户-设置过期时间为前一天")
...
class TestIamTenantAclIP:
    ...
    @allure.title("IAM-租户-访问控制-IP禁止登录")
    ...
    @allure.title("IAM-租户-访问控制-IP允许登录")
...
class TestIamTenantAclDate:
    ...
    @allure.title("IAM-租户-访问控制-当前日期范围内登录")
    ...
    @allure.title("IAM-租户-访问控制-过期日期范围")
    ...
    @allure.title("IAM-租户-访问控制-仅当天日期")
...
class TestIamTenantAclTime:
    ...
    @allure.title("IAM-租户-访问控制-当前时间允许登录")
    ...
    @allure.title("IAM-租户-访问控制-非当前时间禁止登录")
...
class TestIamTenantAclCombined:
    ...
    @allure.title("IAM-租户-访问控制-组合非本地IP+时间+当天")
    ...
    @allure.title("IAM-租户-访问控制-组合本地IP+过期时间+当天")
    ...
    @allure.title("IAM-租户-访问控制-组合非本地IP+时间+昨天")
    ...
    @allure.title("IAM-租户-访问控制-组合本地IP+时间+当天")
