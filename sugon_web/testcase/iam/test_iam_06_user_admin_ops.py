...
class TestIamUserBasicOps:
    ...
    def test_iam_user_status_toggle(self, iam_page, iam_shared_user):
        ...
        with allure_step_log(f"步骤1: 禁用用户 {disp}"):
            iam_page.iam_modify_user_status(disp, enabled=False)
    ...
    def test_iam_reset_password(self, iam_page, iam_shared_user):
        disp = iam_shared_user["display_name"]
        username = iam_shared_user["name"]
    ...
    def test_iam_user_expiry_past(self, iam_page, iam_shared_user):
        disp = iam_shared_user["display_name"]
        username = iam_shared_user["name"]
        password = iam_shared_user["password"]
    ...
    def test_iam_user_expiry_today(self, iam_page, iam_shared_user):
        disp = iam_shared_user["display_name"]
        username = iam_shared_user["name"]
        password = iam_shared_user["password"]
    ...
    def test_iam_user_expiry_future(self, iam_page, iam_shared_user):
        disp = iam_shared_user["display_name"]
        username = iam_shared_user["name"]
        password = iam_shared_user["password"]
