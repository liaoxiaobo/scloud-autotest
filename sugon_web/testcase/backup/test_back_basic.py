...
class TestBackupCreate:
    ...
    def test_backup_create_scenario(self, backup_page, vm_backup, cleanup_backup_task, policy):
        """测试创建每周增量备份任务"""
        allure.dynamic.title(f"备份任务-创建和删除（{policy['case_name']}）")
