...
@allure.story('实例管理-详情页')
class TestSCRInstanceDetail:
    """SCR 实例详情页测试类：节点云硬盘扩容、命名空间管理、公网IP绑定解绑。"""
