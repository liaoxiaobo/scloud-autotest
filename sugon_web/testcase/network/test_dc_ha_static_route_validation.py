...
@allure.story('HA静态路由生效性验证')
class TestDCHaStaticRouteValidation:
    ...
    @allure.title("云专线DC-HA实例静态路由生效性验证")
    def test_ha_static_route_validation(self, vm, vpc, dc_page, vpc_page, ssh_vm):
        """测试HA实例静态路由生效性。
        ...
        try:
            ...
            with allure_step_log("步骤4: SSH连接vm1验证静态路由生效"):
                ...
                # 浏览器端截图：路由表页面
                screenshot_path = f"screenshots/test_ha_static_route_validation_ping_{int(time.time())}.png"
