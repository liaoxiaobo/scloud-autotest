...
class TestECSBasic:
    ...
    @allure.title(f"验证重启、强制重启、强制关机功能")
    ...
    @allure.title(f"验证电源操作挂起&恢复运行功能")
