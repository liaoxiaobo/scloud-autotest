...
class VpcPage(BasePage):
    ...
    def peer_connect_create(self, name, requester_vpc, receiver_vpc, desc=""):
        ...
        Args:
            name: 对等连接名称。
            requester_vpc: 本端VPC名称，仅支持选择当前账户下的VPC。
            receiver_vpc: 对端VPC名称，仅支持选择当前账户下的VPC。
            desc: 对等连接描述，默认空字符串。
        """
        self.btn_create.click()
        self.wait_for_page_ready()
        ...
        # 等待本端VPC下拉框完全关闭，避免对端VPC下拉框定位到残留的动画元素
